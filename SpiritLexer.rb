...
module Spirit
  ...
  class Lexer < ANTLR3::Lexer
    ...
    RULE_NAMES   = [ "T__20", "T__21", "T__22", "T__23", "T__24", "T__25", 
                     ...
                     "BINARYOPERATORS", "COMPARITIONOPERATORS", "IDENTIFIER", 
    ...
    # lexer rule binaryoperators! (BINARYOPERATORS)
    # (in Spirit.g)
    def binaryoperators!
      # -> uncomment the next line to manually enable rule tracing
    ...
    def comparitionoperators!
      ...
      when 0x3d then alt_2 = 1
      when 0x3c then look_2_2 = @input.peek( 2 )
      ...
      when 0x3e then look_2_3 = @input.peek( 2 )
    ...
    def identifier!
      ...
      # - - - - main rule block - - - -
      # at line 348:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
    ...
    def arrayidentifier!
      ...
      # - - - - main rule block - - - -
      # at line 351:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* '[' ']'
      if @input.peek( 1 ).between?( 0x41, 0x5a ) || @input.peek(1) == 0x5f || @input.peek( 1 ).between?( 0x61, 0x7a )
        @input.consume
      else
        mse = MismatchedSet( nil )
    ...
    def char!
      ...
      # - - - - main rule block - - - -
      # at line 356:8: '\\'' ( ESC_SEQ | ~ ( '\\'' | '\\\\' ) ) '\\''
      match( 0x27 )
      # at line 356:13: ( ESC_SEQ | ~ ( '\\'' | '\\\\' ) )
      alt_6 = 2
    ...
    def float!
      ...
      # - - - - main rule block - - - -
      # at line 360:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '0' .. '9' )+ EXPONENT )
      alt_13 = 3
      alt_13 = @dfa13.predict( @input )
      case alt_13
      when 1
        # at line 360:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
        # at file 360:9: ( '0' .. '9' )+
        match_count_7 = 0
        while true
          alt_7 = 2
    ...
    def string!
      ...
      # - - - - main rule block - - - -
      # at line 373:8: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
      match( 0x22 )
      # at line 373:12: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
      while true # decision 14
        ...
        if ( look_14_0 == 0x5c )
          alt_14 = 1
        elsif ( look_14_0.between?( 0x0, 0x21 ) || look_14_0.between?( 0x23, 0x5b ) || look_14_0.between?( 0x5d, 0xffff ) )
          alt_14 = 2

        end
        case alt_14
        when 1
          # at line 373:14: ESC_SEQ
          esc_seq!
    ...
    def exponent!
      ...
      if ( look_15_0 == 0x2b || look_15_0 == 0x2d )
        alt_15 = 1
      end
      case alt_15
      when 1
    ...
    def esc_seq!
      ...
      # - - - - main rule block - - - -
      # at line 384:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
      alt_17 = 3
      look_17_0 = @input.peek( 1 )

      if ( look_17_0 == 0x5c )
        case look_17 = @input.peek( 2 )
        when 0x22, 0x27, 0x5c, 0x62, 0x66, 0x6e, 0x72, 0x74 then alt_17 = 1
        when 0x75 then alt_17 = 2
        when 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37 then alt_17 = 3
        else
      ...
      when 2
        # at line 385:9: UNICODE_ESC
        unicode_esc!

      when 3
        # at line 386:9: OCTAL_ESC
        octal_esc!
    ...
    def octal_esc!
      ...
      # - - - - main rule block - - - -
      # at line 391:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
      alt_18 = 3
      ...
      if ( look_18_0 == 0x5c )
        ...
        if ( look_18_1.between?( 0x30, 0x33 ) )
          look_18_2 = @input.peek( 3 )

          if ( look_18_2.between?( 0x30, 0x37 ) )
            look_18_4 = @input.peek( 4 )

            if ( look_18_4.between?( 0x30, 0x37 ) )
              alt_18 = 1
            else
              alt_18 = 2
            end
        ...
        elsif ( look_18_1.between?( 0x34, 0x37 ) )
          look_18_3 = @input.peek( 3 )

          if ( look_18_3.between?( 0x30, 0x37 ) )
            alt_18 = 2
          else
            alt_18 = 3
          end
    ...
    def unicode_esc!
      ...
      # - - - - main rule block - - - -
      # at line 398:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
      match( 0x5c )
      match( 0x75 )
      hex_digit!
      hex_digit!
    ...
    def token!
      ...
      when 34
        # at line 1:258: BINARYOPERATORS
        binaryoperators!

      when 35
        # at line 1:274: COMPARITIONOPERATORS
        comparitionoperators!

      when 36
        # at line 1:295: IDENTIFIER
        identifier!

      when 37
        # at line 1:306: ARRAYIDENTIFIER
        arrayidentifier!

      when 38
        # at line 1:322: INTEGER
        integer!
    ...
    class DFA13 < ANTLR3::DFA
      ...
      def description
        <<-'__dfa_description__'.strip!
          359:1: FLOAT : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '0' .. '9' )+ EXPONENT );
        __dfa_description__
      end
    end
    class DFA19 < ANTLR3::DFA
      EOT = unpack( 1, -1, 2, 36, 2, -1, 2, 36, 2, -1, 1, 36, 2, -1, 3, 
                    36, 2, -1, 1, 48, 1, 49, 5, 36, 4, -1, 1, 36, 1, 56, 
                    3, -1, 3, 36, 2, -1, 7, 36, 1, 66, 2, 36, 3, -1, 5, 
                    36, 1, -1, 8, 36, 1, 84, 1, -1, 3, 36, 1, 88, 5, 36, 
                    1, 94, 1, 95, 1, 36, 1, 97, 1, 98, 2, 36, 1, 101, 1, 
                    -1, 2, 36, 1, 104, 1, -1, 4, 36, 1, 111, 2, -1, 1, 36, 
                    2, -1, 1, 36, 1, 114, 1, -1, 1, 115, 1, 36, 1, -1, 4, 
                    36, 1, 121, 1, 122, 1, -1, 1, 123, 1, 36, 2, -1, 1, 
                    36, 1, 126, 3, 36, 3, -1, 1, 130, 1, 131, 1, -1, 1, 
                    132, 2, 36, 3, -1, 1, 36, 1, 136, 1, 36, 1, -1, 1, 138, 
                    1, -1 )
      EOF = unpack( 139, -1 )
      MIN = unpack( 1, 9, 2, 48, 2, -1, 2, 48, 2, -1, 1, 48, 2, -1, 3, 48, 
                    2, -1, 1, 61, 6, 48, 4, -1, 1, 48, 1, 46, 3, -1, 3, 
                    48, 2, -1, 10, 48, 3, -1, 5, 48, 1, -1, 9, 48, 1, -1, 
                    17, 48, 1, -1, 3, 48, 1, -1, 5, 48, 2, -1, 1, 48, 2, 
                    -1, 2, 48, 1, -1, 2, 48, 1, -1, 6, 48, 1, -1, 2, 48, 
                    2, -1, 5, 48, 3, -1, 2, 48, 1, -1, 3, 48, 3, -1, 3, 
                    48, 1, -1, 1, 48, 1, -1 )
      MAX = unpack( 1, 125, 2, 122, 2, -1, 2, 122, 2, -1, 1, 122, 2, -1, 
                    3, 122, 2, -1, 1, 61, 1, 57, 5, 122, 4, -1, 1, 122, 
                    1, 101, 3, -1, 3, 122, 2, -1, 10, 122, 3, -1, 5, 122, 
                    1, -1, 9, 122, 1, -1, 17, 122, 1, -1, 3, 122, 1, -1, 
                    5, 122, 2, -1, 1, 122, 2, -1, 2, 122, 1, -1, 2, 122, 
                    1, -1, 6, 122, 1, -1, 2, 122, 2, -1, 5, 122, 3, -1, 
                    2, 122, 1, -1, 3, 122, 3, -1, 3, 122, 1, -1, 1, 122, 
                    1, -1 )
      ACCEPT = unpack( 3, -1, 1, 3, 1, 4, 2, -1, 1, 8, 1, 9, 1, -1, 1, 11, 
                       1, 12, 3, -1, 1, 17, 1, 18, 7, -1, 1, 32, 1, 33, 
                       1, 34, 1, 35, 2, -1, 1, 39, 1, 41, 1, 42, 3, -1, 
                       1, 36, 1, 37, 10, -1, 1, 19, 1, 20, 1, 40, 5, -1, 
                       1, 38, 9, -1, 1, 24, 17, -1, 1, 13, 3, -1, 1, 22, 
                       5, -1, 1, 14, 1, 2, 1, -1, 1, 7, 1, 6, 2, -1, 1, 
                       26, 2, -1, 1, 21, 6, -1, 1, 1, 2, -1, 1, 25, 1, 15, 
                       5, -1, 1, 27, 1, 28, 1, 5, 2, -1, 1, 23, 3, -1, 1, 
                       10, 1, 16, 1, 29, 3, -1, 1, 31, 1, -1, 1, 30 )
      SPECIAL = unpack( 139, -1 )
      TRANSITION = [
        unpack( 2, 31, 2, -1, 1, 31, 18, -1, 1, 31, 1, 27, 1, 32, 3, -1, 
                1, 26, 1, 30, 1, 7, 1, 8, 1, 24, 1, 25, 1, 11, 1, 25, 1, 
                18, 1, 24, 10, 29, 1, -1, 1, 10, 1, 27, 1, 17, 1, 27, 2, 
                -1, 12, 28, 1, 2, 13, 28, 1, 15, 1, -1, 1, 16, 1, -1, 1, 
                28, 1, -1, 1, 28, 1, 14, 1, 1, 1, 28, 1, 9, 1, 13, 2, 28, 
                1, 12, 3, 28, 1, 5, 1, 20, 1, 28, 1, 23, 1, 28, 1, 21, 1, 
                28, 1, 19, 1, 28, 1, 6, 1, 22, 3, 28, 1, 3, 1, 26, 1, 4 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 7, 35, 
                 1, 34, 3, 35, 1, 33, 14, 35 ),
        ...
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 26, 
                 35 ),
        unpack( 1, 50, 1, -1, 10, 29, 11, -1, 1, 50, 31, -1, 1, 50 ),
        unpack(  ),
        unpack(  ),
        unpack(  ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 1, 57, 
                 25, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 1, 58, 
                 25, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 26, 
                 35 ),
        unpack(  ),
        ...
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 22, 
                 35, 1, 70, 3, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 1, 72, 
                 18, 35, 1, 71, 6, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 8, 35, 
                 1, 73, 17, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 8, 35, 
        ...
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 17, 
                 35, 1, 105, 8, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 2, 35, 
                 1, 108, 1, 107, 4, 35, 1, 106, 17, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 4, 35, 
                 1, 109, 21, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 19, 
                 35, 1, 110, 6, 35 ),
        ...
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 26, 
                 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 1, 116, 
                 25, 35 ),
        unpack(  ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 13, 
                 35, 1, 117, 12, 35 ),
        ...
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 20, 
                 35, 1, 128, 5, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 1, 129, 
                 25, 35 ),
        unpack(  ),
        unpack(  ),
        unpack(  ),
        ...
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 26, 
                 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 1, 35, 
                 1, 133, 24, 35 ),
        unpack( 10, 35, 7, -1, 26, 35, 1, 37, 3, -1, 1, 35, 1, -1, 17, 
                 35, 1, 134, 8, 35 ),
        unpack(  ),
