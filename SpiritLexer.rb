...
# Generated at: 2012-03-21 22:03:31
# 
...
module Spirit
  ...
  class Lexer < ANTLR3::Lexer
    ...
    def identifier!
      ...
      # - - - - main rule block - - - -
      # at line 584:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
    ...
    def arrayidentifier!
      ...
      # - - - - main rule block - - - -
      # at line 587:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* '[' ']'
      if @input.peek( 1 ).between?( 0x41, 0x5a ) || @input.peek(1) == 0x5f || @input.peek( 1 ).between?( 0x61, 0x7a )
        @input.consume
      else
        mse = MismatchedSet( nil )
    ...
    def char!
      ...
      # - - - - main rule block - - - -
      # at line 592:8: '\\'' ( ESC_SEQ | ~ ( '\\'' | '\\\\' ) ) '\\''
      match( 0x27 )
      # at line 592:13: ( ESC_SEQ | ~ ( '\\'' | '\\\\' ) )
      alt_7 = 2
    ...
    def float!
      ...
      # - - - - main rule block - - - -
      # at line 596:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '0' .. '9' )+ EXPONENT )
      alt_14 = 3
      alt_14 = @dfa14.predict( @input )
      case alt_14
      when 1
        # at line 596:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
        # at file 596:9: ( '0' .. '9' )+
        match_count_8 = 0
        while true
          alt_8 = 2
    ...
    def string!
      ...
      # - - - - main rule block - - - -
      # at line 609:8: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
      match( 0x22 )
      # at line 609:12: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
    ...
    def esc_seq!
      ...
      # - - - - main rule block - - - -
      # at line 620:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
      alt_18 = 3
      ...
      when 2
        # at line 621:9: UNICODE_ESC
        unicode_esc!

      when 3
        # at line 622:9: OCTAL_ESC
        octal_esc!
    ...
    def octal_esc!
      ...
      # - - - - main rule block - - - -
      # at line 627:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
      alt_19 = 3
    ...
    def unicode_esc!
      ...
      # - - - - main rule block - - - -
      # at line 634:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
      match( 0x5c )
      match( 0x75 )
      hex_digit!
      hex_digit!
    ...
    class DFA14 < ANTLR3::DFA
      ...
      def description
        <<-'__dfa_description__'.strip!
          595:1: FLOAT : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '0' .. '9' )+ EXPONENT );
        __dfa_description__
      end
    end
